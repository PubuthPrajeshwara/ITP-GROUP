...
app.post('/employee/', async (request, response) => {
  ...
  const Supplier = require("./models/supplyModels/supplierModel");
  ...
  app.get('/supplier/', async (request, response) => {
    try {
  ...
  app.get('/supplier/:id', async (request, response) => {
    try {
      const { id } = request.params;
  ...
  app.put('/supplier/:id', async (request, response) => {
    try {
      const updateData = {
        companyName: request.body.companyName,
        contactNumber: request.body.contactNumber,
  ...
  app.delete('/supplier/:id', async (request, response) => {
    try {
      const { id } = request.params;
  ...
  const SupplyRequest = require("./models/supplyModels/supplyRequest");

  // Route for saving a new supply request
  app.post('/supplyrequest/', async (req, res) => {
    try {
  ...
  app.get('/supplyrequest/', async (req, res) => {
    try {
  ...
  app.get('/supplyrequest/:id', async (req, res) => {
    try {
  ...
  app.put('/supplyrequest/:id', async (req, res) => {
    try {
  ...
  app.delete('/supplyrequest/:id', async (req, res) => {
    try {
